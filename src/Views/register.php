    ...
    <div class="App">
        <div class="AppContainer">
            ...
            <div class="login-container">
                <div class="login-wrapper" data-overflow-scroll="true">
                                            ...
                                            <div class="FormItem TextInputWrapper">
                                                ...
                                                <div class="TextInput__fieldOuterWrapper">
                                                    <div class="TextInput__fieldWrapper">
                                                        ...
                                                        <input type="text" class="TextInput TextInput--large Layout--sizeLarge" placeholder="First name" name="firstName" id="firstName" autocapitalize="none" value onblur="validateFirstName();" onfocus="clearError('firstName');" />
                                                    </div>
                                                    <div class="FormRequirement"></div>
                                                </div>
                                            </div>
...
<script>
    ...
    function updateLoginButtonState() {
        loginButton.disabled = !(isUsernameValid && isPasswordValid && isPasswordConfirmationValid && isEmailValid && isFirstNameValid && isLastNameValid);
    }
